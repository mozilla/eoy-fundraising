...
function eoy_2014_theme_scripts_and_stylesheets() {
  ...
  wp_enqueue_script( 'odometer', get_stylesheet_directory_uri() . '/js/odometer.js', array(), '', true );
  wp_enqueue_script( 'totalizer', get_stylesheet_directory_uri() . '/js/totalizer.js', array(), '', true );
